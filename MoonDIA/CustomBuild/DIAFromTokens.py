...
This directly implements DIA's decoding logic without import issues.
"""
...
# ============================================================================
# DIA DAC DECODER (Direct Implementation)
# ============================================================================

class DIADACDecoder:
    """DIA DAC decoder that directly implements DIA's decoding logic."""
    ...
    def decode(self, audio_codes: torch.Tensor) -> torch.Tensor:
        ...
        This is the exact DIA decoding logic from DIAAudio/model.py.
        ...
        # Use DIA's exact decoding logic (copied from DIAAudio/model.py _decode method)
        with torch.no_grad():
...
# ============================================================================
# DIA FROM TOKENS PIPELINE
# ============================================================================

class DIAFromTokens:
    """
    Pipeline that uses DIA's DAC decoder to generate audio from DAC tokens.
    This implements the core DIA functionality without import issues.
    """
    
    def __init__(self):
        """Initialize the DIA From Tokens Pipeline."""
        print("Initializing DIA From Tokens Pipeline...")
        ...
        self.dac_decoder = DIADACDecoder()
        print("✅ DIA DAC decoder loaded")
        
        print("✅ DIA From Tokens Pipeline initialized")
    
    def dac_tokens_to_dia_audio(self, dac_tokens, output_path=None):
        """
        ...
        # Validate token range (DAC expects 0-1023)
        if dac_tokens.min() < 0 or dac_tokens.max() > 1023:
            print(f"  Warning: DAC tokens outside valid range [0, 1023]. Min: {dac_tokens.min()}, Max: {dac_tokens.max()}")
            # Clamp to valid range
            dac_tokens = torch.clamp(dac_tokens, 0, 1023)
            print(f"  Clamped tokens to valid range")
    ...
    def process_dac_tokens_file(self, dac_tokens_path, output_path=None):
        ...
        audio = self.dac_tokens_to_dia_audio(dac_tokens, output_path)
...
def main():
    """Test the DIA From Tokens Pipeline."""
    print("Testing DIA From Tokens Pipeline")
    print("=" * 50)
    
    # Initialize pipeline
    pipeline = DIAFromTokens()
    ...
    print("\n✅ DIA From Tokens pipeline test completed!")
